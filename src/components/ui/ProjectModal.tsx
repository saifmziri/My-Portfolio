            ...
            <div className="flex flex-wrap items-center gap-3">
              {project.githubFrontend && (
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg border border-cyan-500/30 bg-cyan-950/30 text-sm font-medium text-cyan-300 hover:bg-cyan-900/50 hover:text-[#E8EAE3] transition-colors"
                >
              ...
              {project.githubBackend && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg border border-indigo-500/30 bg-indigo-950/30 text-sm font-medium text-indigo-300 hover:bg-indigo-900/50 hover:text-[#E8EAE3] transition-colors"
                >
              ...
              {project.github && !project.githubFrontend && !project.githubBackend && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg border border-[#3F4739] bg-white/5 text-sm font-medium text-[#E8EAE3] hover:bg-white/10 transition-colors"
                >
              ...
              {project.linkedinPost && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg border border-blue-500/30 bg-blue-950/30 text-sm font-medium text-blue-300 hover:bg-blue-900/50 hover:text-[#E8EAE3] transition-colors"
                >
              ...
              {project.instagramPost && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg border border-pink-500/30 bg-pink-950/30 text-sm font-medium text-pink-300 hover:bg-pink-900/50 hover:text-[#E8EAE3] transition-colors"
                >
