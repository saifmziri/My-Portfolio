    ...
    const skillsData = [
        {
            ...
            icon: "fa-server",
            items: ["C# / .NET Core", "Windows Forms", "WPF (XAML)", "RESTful APIs", "C++", "SQL Server"]
        },
        {
            category: "Web Frontend",
            icon: "fa-code",
            items: ["HTML5 & CSS3", "JavaScript (ES6+)", "TypeScript", "GSAP Animations", "Responsive Design", "DOM Manipulation"]
        },
        {
            category: "Tools & Workflow",
            icon: "fa-screwdriver-wrench",
            items: ["Visual Studio", "Git & GitHub", "Postman", "Chrome DevTools", "Agile/Scrum", "CI/CD Basics"]
        }
    ];
    ...
    const projectsData = [
        {
            ...
            description: "A comprehensive Windows Forms application designed for large-scale inventory management. Features real-time tracking, barcode scanning integration, and automated reporting.",
        ...
        },
        {
            ...
            description: "A full-stack web application with a responsive dashboard, showcasing the power of vanilla JavaScript and clean CSS architecture without relying on heavy frameworks.",
        ...
        },
        {
            ...
            description: "High-performance WPF application handling complex data visualization. Utilizes MVVM architecture to separate data processing from the UI layer.",
            tech: ["C#", "WPF (XAML)", "MVVM", "Data Binding"],
            image: "assets/", // Set to "assets/filename.jpg"
            icon: "fa-chart-line",
            imageLabel: "WPF Charting UI"
        }
    ];
